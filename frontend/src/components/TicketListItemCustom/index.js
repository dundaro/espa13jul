...
{/*CHATGROW INSERIDO O dentro do const handleChangeTab*/ }
    ...
    <React.Fragment key={ticket.id}>
      ...
      >
        <Tooltip arrow placement="right" title={ticket.queue?.name?.toUpperCase() || "SEM FILA"} >
          <span style={{ backgroundColor: ticket.queue?.color || "#fff" }} className={classes.ticketQueueColor}></span>
        </Tooltip>
        <ListItemAvatar>
        ...
        <span className={classes.secondaryContentSecond} >
          {ticket.status === "pending" && (
            <ButtonWithSpinner
              //color="primary"
              style={{ backgroundColor: '#0850EB', color: 'white', padding: '0px', bottom: '17px', borderRadius: '7px', left: '8px', fontSize: '0.6rem' }}
              variant="contained"
          ...
          {(ticket.status !== "closed") && (
            <ButtonWithSpinner
              //color="primary"
              style={{ backgroundColor: '#F50057', color: 'white', padding: '0px', bottom: '0px', borderRadius: '7px', left: '8px', fontSize: '0.6rem' }}
              variant="contained"
              className={classes.acceptButton}
              size="small"
              loading={loading}
